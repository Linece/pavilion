...
//	String path=(HCNetSDK.class.getResource("/").getPath()).replaceAll("%20", " ").substring(1).replace("/", "\\")+"HCNetSDK.dll";
	...
	String path = "E:\\hc\\HCNetSDK.dll";

    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(HcOpenApi.getPath(path),
           HCNetSDK.class);
...
{
	String path=(HCNetSDK.class.getResource("/").getPath()).replaceAll("%20", " ").substring(1).replace("/", "\\")+"PlayCtrl.dll";
